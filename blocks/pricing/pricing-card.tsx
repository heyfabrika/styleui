  ...
  return (
    <Card
      className={cn(
        ...
        !isFree &&
          "bg-gradient-to-tl from-transparent via-transparent dark:via-secondary/10 to-primary/10 dark:to-secondary/50 border border-primary/50 min-h-96 4xl:min-h-120 backdrop-blur-xl",
        className
      )}
    >

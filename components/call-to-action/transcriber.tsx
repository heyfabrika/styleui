...
export default function Transcriber() {
  ...
  return (
    <motion.div
      ...
      className="flex flex-col gap-4 md:gap-8 w-full max-w-xs md:max-w-sm xl:max-w-md 4xl:max-w-2xl bg-gradient-to-b from-background to-zinc-100 dark:to-muted p-3 md:p-4 rounded-lg"
    >
      <motion.section
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      <motion.section
        ...
        className="h-3 lg:h-4 4xl:h-6 w-full bg-muted-foreground/20 rounded-t-full origin-left"
      />
      ...
      <motion.section
        ...
        className="relative shadow-xl rounded-2xl md:rounded-3xl bg-background flex flex-col gap-3 md:gap-4 4xl:gap-20 p-3 md:p-4 min-h-64 md:min-h-90 4xl:min-h-140 overflow-hidden"
      >
        <motion.div
          ...
          className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-none w-40 h-40 md:w-[13.75rem] md:h-[13.75rem] 4xl:w-[16rem] 4xl:h-[16rem]"
          style={{
            borderRadius: 232,
            background:

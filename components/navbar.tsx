...
export default function Navbar() {
  ...
  return (
    <div className="fixed top-0 left-1/2 -translate-x-1/2 z-50 mx-2 md:mx-4 lg:mx-6 w-full md:max-w-3xl lg:max-w-5xl xl:max-w-6xl bg-background/80 backdrop-blur-sm py-2 px-4 rounded-b-3xl">

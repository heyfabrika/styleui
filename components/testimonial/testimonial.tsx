...
export default function Testimonial() {
  return (
    <div className="py-24 px-4 max-w-6xl mx-auto flex flex-col gap-12">
      <motion.section
      ...
      <section className="grid grid-cols-1 md:grid-cols-5 gap-6">
        ...
        >
          <TestimonialCard
            logo="https://cdn.brandfetch.io/id6B0ZV-R2/theme/dark/logo.svg?c=1bxid64Mup7aczewSAYMX&t=1733967977437"
